...
sumstats_bellenguez.hg19 = read_tsv("/sc/arion/projects/load/users/pradha04/projects/aimagma/abc_magma/data/whiteman/PGCALZ2sumstatsIncluding23andMeMETALNoUKB.chrall.CPRA_b37.tsv")

sumstats_bellenguez.hg19 <- sumstats_bellenguez.hg19[!is.na(sumstats_bellenguez.hg19$POS), ]
...
unique(bellenguez_nott.annot) %>% write.table(paste0("/sc/arion/projects/load/users/pradha04/projects/aimagma/nott/annotations/wightman/PGCALZ2sumstatsIncluding23andMeMETALNoUKB_chrall.genes.annot"), row.names = FALSE, col.names = FALSE, sep = " ", quote = FALSE)
